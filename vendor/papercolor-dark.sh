...
#}#!/bin/sh
# Base16 PaperColor Dark - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 808080 # forground
  printf $printf_template_custom Ph 1c1c1c # background
  printf $printf_template_custom Pi 808080 # bold color
  printf $printf_template_custom Pj 5faf00 # selection color
  printf $printf_template_custom Pk 808080 # selected text color
