...
color_foreground="00/87/00" # Base 02
color_background="87/87/87" # Base 07
color_cursor="00/87/00" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 008700 # forground
  printf $printf_template_custom Ph 878787 # background
  printf $printf_template_custom Pi 008700 # bold color
  printf $printf_template_custom Pj 444444 # selection color
  printf $printf_template_custom Pk 008700 # selected text color
  printf $printf_template_custom Pl 008700 # cursor
  printf $printf_template_custom Pm 878787 # cursor text
else
